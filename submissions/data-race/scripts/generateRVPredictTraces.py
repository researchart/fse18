...
for test in benchmarks:
    ...
    if (test in small_benchmarks):
        command = [rvpredict, '--log',  '--base-log-dir', ld, '--log-dirname', test, '-cp', small_jar, testclass_map[test]]
    elif (test in medium_benchmarks):
        command = [rvpredict, '--log',  '--base-log-dir', ld, '--log-dirname', test, '-cp', medium_jar, testclass_map[test]]
